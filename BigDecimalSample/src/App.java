...
public class App {
    ...
    private static void calcKetaochi() {
        ...
        float d3 = d1 - d2; // 0.1234568 - 0.1234556 = 0.0000012 ≈ 正規化すると(仮数部の最上位桁を0以外の値にする作業)、0.12 * 10^-5
                            // になる.
    ...
    private static void calcMarumeGosa() {
        ...
        // 丸め誤差していてもformatをかければ勝手に四捨五入してくれるので、表示上問題なくなる.
        // "%.1f": 小数点第二位で四捨五入して小数点第一位まで表示.
        String formatStr = String.format("%.1f", 0.3F + 0.3F + 0.3F);
